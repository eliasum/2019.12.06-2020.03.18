<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FBAlertsOptions.ascx.cs" Inherits="FBAlertsOptions" %>
...
<div runat="server" id="divFBAlertsOptions" class="next"  ></div>
